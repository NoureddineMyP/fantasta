    ...
    if (hasStats || hasInjuries) {
      ...
      if (seasons.length) {
        ...
        sections.push(`<div><p class="text-xs font-bold uppercase text-slate-400">Presenze, gol, assist e partite saltate</p>
          <p class="mt-0.5 text-[11px] italic text-slate-400">PG/Gol/Assist per stagione, tutte le competizioni</p>
      ...
      sections.push(`<p class="text-xs text-slate-500">Nessuna presenza ufficiale risulta su Transfermarkt per questo giocatore. Lo storico infortuni resta comunque disponibile se presente.</p>`);
    }
